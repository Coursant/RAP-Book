...
In this way, we can enumerate valuable paths of a SCC tree in a bottom-up manner. We define a path as from the dominator to an exit of the sub SCC. For example, `7-8-10-21-24-11-20-25-19-26` is a path. A path is worth further exploration if the last trip between two dominator introduces previously unvisited node. For example, `7-8-10-21-24-11-20-25-19-13-7-8-10-21-24-11-20-25-19-13-7` is not worthy because the second part is an duplication of the first. In comparison, `7-8-10-21-24-11-20-25-19-13-7-9-10-21-24-11-20-25-19-13-7` is worthy because the second part introduces a new node 9 which may introduce new aliases. The resulting path is `7-8-10-21-24-11-20-25-19-13-7-9-10-21-24-11-20-25-19-13-7-8-10-21-24-11-20-25-19-26`. In this we, our approach generate the following 10 paths for the inner SCC.
