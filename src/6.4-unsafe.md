...
<pre style="font-family: monospace; background: #f8f8f8; padding: 10px; border-radius: 5px">
    Γ ⊢ statement: left_ptr = Call(func, [base_ptr, offset_val]),
        func ∈ {ptr::byte_add, ptr::byte_offset, ptr::byte_sub, ptr::wrapping_byte_add, ptr::wrapping_byte_offset, ptr::wrapping_byte_sub},
...
<pre style="font-family: monospace; background: #f8f8f8; padding: 10px; border-radius: 5px">
    ...
    Γ ⊢ new_ptr.offset = new_byte_offset 
        ▸ Tag(new_ptr, Aligned) if ( new_byte_offset % A_src == 0 ∧ A_src < A_dst )
...
**Rule5 (U-Source)**:
<pre style="font-family: monospace; background: #f8f8f8; padding: 10px; border-radius: 5px">
    Γ ⊢ context, statement: left_var = (Copy(external_ptr) | Move(external_ptr))
...
<pre style="font-family: monospace; background: #f8f8f8; padding: 10px; border-radius: 5px">
    Γ ⊢ statement: left_ptr = Call(func, [ptr, new_offset]),
        func ∈ {ptr::add, ptr::offset, ptr::sub, ptr::wrapping_add, ptr::wrapping_offset, ptr::wrapping_sub},
